...
/*   Updated: 2023/12/01 17:02:12 by wmarien          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	err_msg(t_err err)
{
	if (err.msg == ERRMSG_CMD_NOT_FOUND)
		return (ft_putstr_fd("\033[31m» \033[36mminishell:\033[0;97m ", 2), ft_putstr_fd(err.cause, 2),
		...
		return (ft_putstr_fd("\033[31m» \033[36mminishell:\033[0;97m exit: too many arguments\n", 2),
			err.no);
